...
CSV_COLUMNS = [
    ...
    "degree_centrality_avg", "betweenness_centrality_avg", "closeness_centrality_avg",
    "clustering_coeff_avg", "transitive_ratio",
    ...
    def compute_migration_metrics(self, graph_metrics: dict, aot_results: dict) -> dict:
        return {
            **graph_metrics,
            ...
            'total_metadata': aot_results.get('total_metadata', 0),
            'metadata_density': aot_results.get('metadata_density', 0.0),
            'build_status': aot_results.get('build_status', 0)
        }
